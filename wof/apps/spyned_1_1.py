...
def TWOFService(wof_inst, T, T_name):
    # Flavio:
    # This is the constructor of the spyne service based on a user code application (wof_inst),
    # called inside getSpyneApplications (from core.py)
    # the user code will either be a WOF object (from core_1_0.py) or a WOF_1_1 object (from core_1_1.py)
    # in this specific case it will always be a WOF_1_1 object
    #
    class WOFService(ServiceBase):
        ...
        def GetSitesObject(ctx, site=None, authToken=None):
            try:
                ...
                # Flavio: Generates a siteInfoResponseType (WaterML_1_1.py)
                #         object, exports it as XML into outstream
                #         and returns outstream value
